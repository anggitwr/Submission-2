...
class MainActivity : AppCompatActivity() {
    ...
    private fun getUser() {
        ...
        client.addHeader("Authorization", "token c3c3a97f38295b3c631cfaef3bb0a255b8ec7a6a")
    ...
    private fun getUserDetail(id: String) {
        ...
        val client = AsyncHttpClient()
        client.addHeader("User-Agent", "request")
        client.addHeader("Authorizaton", "token  c3c3a97f38295b3c631cfaef3bb0a255b8ec7a6a")
    ...
    private fun showRecyclerList() {
        ...
        val listDataAdapter = DataAdapter(userFilterList)
        recycleView.adapter = adapter

        listDataAdapter.setOnItemClickCallback(object : DataAdapter.OnItemClickCallback {
            override fun onItemClicked(dataUser: DataUser) {
                showSelectedUser(dataUser)
            }
        })
    }
